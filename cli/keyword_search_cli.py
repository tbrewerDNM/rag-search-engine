...
def main() -> None:
    ...
    tdidf_parser = subparsers.add_parser(
        "tfidf", help="Get term frequency for a given document ID and term"
    )
    tdidf_parser.add_argument("doc_id", type=int, help="Document ID")
    tdidf_parser.add_argument("term", type=str, help="Term to get frequency for")
